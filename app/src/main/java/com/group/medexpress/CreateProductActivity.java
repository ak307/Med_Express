    ...
    private void setProductImgView(){
        productImgView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(ContextCompat.checkSelfPermission(CreateProductActivity.this, permission)
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Glide.with(CreateProductActivity.this.getApplicationContext())
                        .load(uri)
                        .into(productImgView);
                ...
                Toast.makeText(CreateProductActivity.this, (CharSequence) error, Toast.LENGTH_LONG).show();
            }
        }
